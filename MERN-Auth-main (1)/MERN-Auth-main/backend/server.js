...
mongoose.connect("mongodb+srv://shiv99:shiv99@usercluster.jo1wmpe.mongodb.net/userDB?retryWrites=true&w=majority");
var fs = require('fs');
...
var upload = multer({
  storage: multer.diskStorage({
    ...
    {
      //If directory does not exist then create a directory
